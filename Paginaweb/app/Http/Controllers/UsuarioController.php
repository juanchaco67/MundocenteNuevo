   ...
   public function store(Request  $request){
       ...
       //return ""; 
        ...
        if($rol === "docente"){
            ...
            //AdminController::enviar_correo('emails.welcome',$user,'Bienvenido');
            AdminController::enviar_correo('emails.aviso',$user,'Bienvenido');
        }
    ...
    public function actualizar_usuario($user, Request $request){
        ...
        if ($request['desactivar']) {
            ...
            if ($user->estado == "inactivo") {
             AdminController::enviar_correo('emails.aviso',$user,'Tu ha sido desactivada');
            } else {
                //echo "no enviarnada";
            }
        } else {
            $user->update(['estado' => 'activo']);
              AdminController::enviar_correo('emails.aviso',$user,'Tu cuenta ha sido activada');
