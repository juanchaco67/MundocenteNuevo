	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body text-center">
	        	<h4>Espera confirmación</h4>
	          	<h5><p>Debes esperar la aprobación del administrador para antes de publicar, te enviaremos un correo electronico para informarte cuando puedas publicar...</p>
	          	</h5>
	        </div>
